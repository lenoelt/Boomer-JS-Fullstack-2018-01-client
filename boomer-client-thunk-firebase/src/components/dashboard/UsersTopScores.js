  ...
  return (
    <div className="Top-Scores section">
      ...
      <ul className="collection with-header">
        ...
        <li className="collection-item"><div>5. User 5<a href="#!" className="secondary-content"><i className="material-icons">star_border</i></a></div></li>
        <li className="collection-item"><div>6. User 6<a href="#!" className="secondary-content"><i className="material-icons">star_border</i></a></div></li>
        <li className="collection-item"><div>7. User 7<a href="#!" className="secondary-content"><i className="material-icons">star_border</i></a></div></li>
        <li className="collection-item"><div>8. User 8<a href="#!" className="secondary-content"><i className="material-icons">star_border</i></a></div></li>
